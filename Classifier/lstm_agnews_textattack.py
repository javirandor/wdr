...
lstm_model = LSTMForClassification(model_path='models/classification/lstm/ag-news')

model = textattack.models.wrappers.PyTorchModelWrapper(lstm_model, lstm_model.tokenizer, batch_size=32)